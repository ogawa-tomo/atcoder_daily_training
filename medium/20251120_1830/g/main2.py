...
for _ in range(Q):
    ...
    print(i_repetition, j_repetition)
    print(min_i_r, min_j_r, max_i_r, max_j_r)
    print(repeat_start_i, repeat_end_i, repeat_start_j, repeat_end_j)
    ...
    # 中
    answer += cum_sum_2d.range_sum(0, 0, N - 1, N - 1) * i_repetition * j_repetition
    if max_j // N > min_j // N and max_j_r < N - 1:
        # 右
